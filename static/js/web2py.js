(function ($, undefined) {
    ...
    $.web2py = web2py = {
        ...
        disableElement: function (el) {
            ...
            if (method == 'val') { // edwin mod begin
                w2p_ajax_disable_with_message = w2p_ajax_disable_with_message_val;
            } else {
                w2p_ajax_disable_with_message = w2p_ajax_disable_with_message_html;
            } // edwin mod end;
