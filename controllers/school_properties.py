...
def teachers():
    ...
    if permission:
        links = [{'header':T('Classes'),
                  'body':teachers_get_link_classes},
                 {'header':T('Events'),
                 ...
                 lambda row: A(SPAN(_class="buttontext button",
                               ...
                               _href=URL('teacher_edit_classtypes',
                                         vars={'uID':row.id})),
                 lambda row: os_gui.get_button('edit',
                                    URL('customers', 'edit',
                                        args=[row.id]),
    ...
    contact_list = A(SPAN(os_gui.get_fa_icon('fa-volume-control-phone'), ' ',
                          T("Contact list")),
                     _href=URL('teachers_export_excel'))
    links = [ contact_list ]
...
def teachers_get_tools(var=None):
    '''
...
def teachers_get_link_classes(row):
    '''
...
def index():
    ...
    # teachers = DIV(A(H3(T("Teachers")),
    #         _href=URL('teachers')),
    #         T("Manage teachers for your studio."),
    #     _class='col-md-4')
    #
    # employees = DIV(A(H3(T("Employees")),
    #         _href=URL('employees')),
    #         T("Manage studio staff."),
    #     _class='col-md-4')
    #
    # mstypes = DIV(A(H3(T("Subscriptions")),
    #         _href=URL('subscriptions')),
    #         T("Define which subscriptions your studio offers."),
    #     _class='col-md-4')
    #
    # classcards = DIV(A(H3(T("Class cards")),
    #         _href=URL('classcards')),
    #         T("Define which class cards your studio offers."),
    #         _class='col-md-4')
    #
    # discovery = DIV(A(H3(T("Discovery")),
    #         _href=URL('discovery')),
    #         T("Discovery allows you to keep track of how customers found your school."),
    #     _class='col-md-4')
    #
    # plevels = DIV(A(H3(T("Practice levels")),
    #         _href=URL('levels')),
    #         T("Define levels for classes and customers."),
    #     _class='col-md-4')
    #
    # classtypes = DIV(A(H3(T("Class types")),
    #         _href=URL('classtypes')),
    #         T("Define class types offered by your studio."),
    #     _class='col-md-4')
    #
    # locations = DIV(A(H3(T("Locations")),
    #         _href=URL('locations')),
    #         T("Locations define locations for classes and workshops."),
    #     _class='col-md-4')
    #
    # keys = DIV(A(H3(T("Keys")),
    #     _href=URL('list_keys')),
    #         T("When keys, swipecards etc. are being distributed to customers, you can get an overview \
    #         here of who has which key."),
    #     _class='col-md-4')
    #
    # languages = DIV(A(H3(T("Languages")),
    #         _href=URL('languages')),
    #         T("Languages are used with customers to keep track of the primary \
    #         language of a customer."),
    #     _class='col-md-4')
    #
    # holidays = DIV(A(H3(T("Holidays")),
    #         _href=URL('schedule', 'holidays')),
    #         T("Set holiday for one or more locations."),
    #     _class='col-md-4')
    #
    # shifts = DIV(A(H3(T("Shifts")),
    #         _href=URL('shifts')),
    #         T("Define shift types for employee schedule."),
    #     _class='col-md-4')
