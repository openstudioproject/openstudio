...
def define_school_subscriptions_cancel_reasons():
    db.define_table('school_subscriptions_cancel_reasons',
        ...
        Field('SortOrder', 'integer',
              ...
              label=T('Sort order'),
              comment=T(
                  "Order in which cancel reasons are shown in the OpenStudio shop. The list will be sorted from low to high. Cancel reasons with the same sort order number are sorted by name."),
              ),
...
def define_customers_orders_items():
    ...
    db.define_table('customers_orders_items',
        ...
        Field('school_classcards_id', db.school_classcards,
            ...
            writable=False),
        Field('customers_subscriptions_id', db.customers_subscriptions,
            # Used to store subscription check-in data when a customer renews a membership
            readable=False,
            writable=False),
        Field('customers_classcards_id', db.customers_classcards,
