    ...
    if not auth.user is None:
        ...
        if user_helpers.check_read_permission('finance', user_id):
            ...
            if user_helpers.check_read_permission('receipts', user_id):
                submenu.append(((I(_class='fa fa-caret-right'), SPAN(T('Receipts'))),
                                False,
        ...
        if user_helpers.check_read_permission('settings', user_id):
            ...
            if user_helpers.check_read_permission('settings_finance', user_id):
                submenu.append(((I(_class='fa fa-caret-right'), SPAN(T('Finance'))),
                                False,
            ...
            submenu.append(((I(_class='fa fa-caret-right'), SPAN(T('Integration'))),
                            False,
                            URL('settings_integration', 'mailchimp', extension='')))
        ...
        if user_helpers.check_read_permission('automated_tasks', user_id):
            ...
            submenu.append(((I(_class='fa fa-caret-right'), SPAN(T('Customer class cards'))),
                            False,
                            URL('automation_customer_classcards', 'index', extension='')))
            submenu.append(((I(_class='fa fa-caret-right'), SPAN(T('Customer memberships'))),
                            False,
                            URL('automation_customer_memberships', 'index', extension='')))
            submenu.append(((I(_class='fa fa-caret-right'), SPAN(T('Customer pictures'))),
                            False,
                            URL('automation_customer_pictures', 'index', extension='')))
